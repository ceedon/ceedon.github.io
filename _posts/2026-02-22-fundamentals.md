...
MBA'ification. Boeing'ification, if you will. The practice of promoting men (_almost always_) who have never been close to the actual work of the business to the top of the org chart until planes start literally falling out of the sky.

Now [this](https://www.npr.org/2024/12/13/nx-s1-5197005/the-indicator-from-planet-money-boeings-biggest-blunder-financial-engineering) [has](https://www.cpajournal.com/2025/08/12/the-story-of-boeings-failed-corporate-culture-3/) [been](https://fortune.com/2024/02/22/boeing-stock-crash-history-737-outlook/) [covered](https://www.library.hbs.edu/working-knowledge/why-boeings-problems-with-737-max-began-more-than-25-years-ago).\
But this is in no way isolated to Boeing. Every PE-backed org in existence is dealing with this in some capacity. A hollowing out of the ecosystem that creates real value for customers in order to make paper value for potential buyers. In many ways, this is not new human behavior. James C. Scott does an incredible job of impressing that in [*Seeing Like a State*](https://en.wikipedia.org/wiki/Seeing_Like_a_State); showing the consequences of governmental practices that seek to simplify complex systems down to stats. What may be new'ish is it happening in business at this scale.
...
I mean a stable software product that saves folks time or solves a previously unsolved problem without toppling over under the injection of AI slop and hallucination.
I mean a plane that goes from Point A to Point B without cutting short the lives and experiences of hundreds of individuals.

The crux of the problem is that the folks making decisions are too far away from the actual work. They don't have time or inclination to grok the nuance of their [domain](https://en.wikipedia.org/wiki/Domain_(software_engineering)). As a result, nonsensical edicts are the norm. Couple this with the constant squeezing of Labor to optimize P&Ls and you have a completely disenfranchised workforce doing what they must to survive.

## Who needs people...
It turns out that those stupid motivational posters aren't wrong. People are our greatest asset. All resilience to date has come from people. Robustness is the domain of machines. As we erode the agency and willingness of folks doing the work to help shape direction, we lose the ability to nudge outputs towards RealValue:tm:. Some argue that LLMs change this. I'd argue that [Ashby's Law](https://en.wikipedia.org/wiki/Variety_(cybernetics)) holds and hallucination is going to bite far before a model of the world will fit in memory. In fact, I'd argue that AI fervor is a case in point.
